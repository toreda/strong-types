...
import {STOpIsDateTime, makeIsDateTime} from '../validator/is-time-date';
...
import {STOpIsHexColorCode, createIsHexColorCode} from '../validator/pattern/is-hex-color-code';
